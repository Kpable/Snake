...
public class Snake : MonoBehaviour {
    ...
    void Awake()
    {
        gameController = GameObject.Find("Gameplay Controller").GetComponent<SnakeGameController>();
    ...
    void GetSnake()
    {
        ...
        for (int i = 0; i < transform.childCount; i++)
        {
            ...
            SnakeSegment segment = transform.GetChild(i).GetComponent<SnakeSegment>();
            // Add it to the snake
            snake.Add(segment);
    ...
    {
        // For each segment
        foreach (SnakeSegment s in snake)
        {
    ...
    void EatFood()
    {
        ...
        segment.GetComponent<SnakeSegment>().SetMovementDelay(snake.Count);
        // Delay collisions with new segment
        collisionDelay = snake.Count;
        // Add the segment to the snake
        snake.Add(segment.GetComponent<SnakeSegment>());
        // Add to score
